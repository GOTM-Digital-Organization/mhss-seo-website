    ...
    >
      <section style={{ backgroundColor: "#0a1520", borderBottom: "1px solid #1E3A5F", paddingTop: "4rem", paddingBottom: "4rem" }}>
        <div className="container">
          <nav style={{ display: "flex", gap: "0.5rem", alignItems: "center", marginBottom: "1.5rem", fontSize: "0.8rem", color: "#64748B" }}>
            ...
            <span style={{ color: "#F59E0B" }}>Hose Reels</span>
          </nav>
          <h1 style={{ fontFamily: "Oswald, sans-serif", fontWeight: 700, fontSize: "clamp(2rem, 4vw, 3rem)", color: "#F1F5F9", lineHeight: 1.1, marginBottom: "1rem" }}>
            Hose Reels — <span style={{ color: "#F59E0B" }}>Titan & Summit</span>
          </h1>
      ...
      <section style={{ paddingTop: "5rem", paddingBottom: "5rem" }}>
        <div className="container">
            ...
            {BRANDS.map(brand => (
              <div key={brand.name} style={{ backgroundColor: "#0d1b2a", border: "1px solid #1E3A5F", borderRadius: "0.625rem", overflow: "hidden" }}>
                <div style={{ padding: "1.5rem 1.75rem 1rem", borderBottom: "1px solid #1E3A5F" }}>
                  <h3 style={{ fontFamily: "Oswald, sans-serif", fontWeight: 700, fontSize: "1.25rem", color: "#F59E0B", marginBottom: "0.4rem" }}>{brand.name}</h3>
          ...
          <div style={{ backgroundColor: "#0d1b2a", border: "1px solid #1E3A5F", borderRadius: "0.625rem", padding: "2rem", marginTop: "2.5rem" }}>
            <h3 style={{ fontFamily: "Oswald, sans-serif", fontWeight: 700, fontSize: "1.1rem", color: "#F1F5F9", marginBottom: "0.75rem" }}>Hose Reel Accessories</h3>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "0.5rem" }}>
              {["Swivel fittings and adapters", "Mounting brackets and hardware", "Replacement hose guides", "Hose reel hose — 3/8\" and 1/2\"", "Electric motor replacement kits", "Reel repair parts"].map(item => (
                <span key={item} style={{ display: "flex", alignItems: "center", gap: "0.4rem", color: "#64748B", fontSize: "0.825rem" }}>
                  <CheckCircle2 size={12} style={{ color: "#F59E0B" }} /> {item}
                </span>
              ))}
            </div>
          </div>
