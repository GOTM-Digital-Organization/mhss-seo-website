      ...
      <section style={{ paddingTop: "5rem", paddingBottom: "5rem" }}>
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <p style={{ color: "#6B7280", fontSize: "0.9rem", marginTop: "0.75rem", maxWidth: "520px", margin: "0.75rem auto 0" }}>
            ...
            {BRANDS.map(brand => (
              <div key={brand.name} style={{ backgroundColor: "#FFFFFF", border: "1px solid #E5E0D8", borderRadius: "0.625rem", overflow: "hidden" }}>
                <div style={{ padding: "1.75rem 1.75rem 1rem", borderBottom: "1px solid #E5E0D8" }}>
                  ...
                  <p style={{ color: "#6B7280", fontSize: "0.875rem", lineHeight: 1.7, margin: 0 }}>{brand.desc}</p>
                </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "1rem" }}>
                    {brand.models.map(m => (
                      <div key={m.model} style={{ backgroundColor: "#FFFFFF", border: "1px solid #E5E0D8", borderRadius: "0.5rem", padding: "1.25rem" }}>
                        ...
                        <p style={{ color: "#6B7280", fontSize: "0.8rem", margin: "0 0 0.75rem" }}>{m.specs}</p>
      ...
      <section style={{ backgroundColor: "#F2EFE9", borderTop: "1px solid #E5E0D8", paddingTop: "4rem", paddingBottom: "4rem" }}>
        <div className="container" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "center" }}>
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "0.6rem" }}>
              {["Pump rebuilds and replacements", "Unloader and regulator service", "Engine repairs and tune-ups", "Hose, gun, and wand replacement", "Hot water burner service", "Annual maintenance packages"].map(i => (
                <li key={i} style={{ display: "flex", alignItems: "center", gap: "0.6rem", color: "#4B5563", fontSize: "0.875rem" }}>
          ...
          <div style={{ backgroundColor: "#FFFFFF", border: "1px solid #E5E0D8", borderRadius: "0.625rem", padding: "2rem" }}>
            ...
            <p style={{ color: "#6B7280", fontSize: "0.875rem", marginBottom: "1.5rem" }}>Visit us at 552 Catarzi Way, Sarasota or call to discuss your equipment needs.</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
              ...
              <Link href="/contact" style={{ border: "2px solid #E5E0D8", color: "#4B5563", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 600, fontSize: "0.875rem", letterSpacing: "0.05em", textTransform: "uppercase", padding: "0.875rem 1.5rem", borderRadius: "0.375rem", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", background: "transparent" }}>
