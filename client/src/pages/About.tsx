      ...
      <section className="relative py-24 overflow-hidden" style={{ backgroundColor: "#18181B" }}>
        ...
        <div className="container relative z-10">
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "clamp(2.5rem, 6vw, 4.5rem)", color: "#FFFFFF", lineHeight: 1.0, marginBottom: "1.25rem" }}>
            ABOUT <span style={{ color: "#F59E0B" }}>MHSS INC.</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.title} className="p-5 rounded-lg" style={{ backgroundColor: "#27272A", borderLeft: "4px solid #F59E0B", border: "1px solid rgba(255,255,255,0.06)", borderLeftWidth: "4px", borderLeftColor: "#F59E0B" }}>
                      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, color: "#FFFFFF", fontSize: "1.05rem", marginBottom: "0.5rem" }}>
                        {item.title}
                      </div>
                      <p style={{ color: "#71717A", fontSize: "0.875rem", lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif" }}>{item.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    <Link key={svc.href} href={svc.href} className="flex items-center gap-3 p-3 rounded transition-colors hover:bg-zinc-700" style={{ backgroundColor: "#27272A", border: "1px solid rgba(255,255,255,0.06)" }}>
                      <ArrowRight size={14} style={{ color: "#F59E0B", flexShrink: 0 }} />
                      <span style={{ color: "#A1A1AA", fontSize: "0.875rem", fontFamily: "'DM Sans', sans-serif" }}>{svc.label}</span>
                    </Link>
                  ))}
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-lg" style={{ backgroundColor: "#27272A", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, color: "#F59E0B", fontSize: "0.75rem", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "1rem" }}>
                  By the Numbers
                </div>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={stat.label} className="flex items-center gap-4">
                      <div className="w-9 h-9 rounded flex items-center justify-center shrink-0" style={{ backgroundColor: "rgba(245,158,11,0.12)", color: "#F59E0B" }}>
                        {stat.icon}
                      </div>
                      <div>
                        <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "1.5rem", color: "#F59E0B", lineHeight: 1 }}>{stat.value}</div>
                        <div style={{ color: "#71717A", fontSize: "0.75rem", fontFamily: "'DM Sans', sans-serif" }}>{stat.label}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="p-6 rounded-lg" style={{ backgroundColor: "#27272A", borderLeft: "4px solid #F59E0B", border: "1px solid rgba(255,255,255,0.06)", borderLeftWidth: "4px", borderLeftColor: "#F59E0B" }}>
                ...
                <p style={{ color: "#A1A1AA", fontSize: "0.875rem", lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif", marginBottom: "1rem" }}>
