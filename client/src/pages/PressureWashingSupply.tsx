  ...
  return (
    ...
    >
      <section className="relative py-24 overflow-hidden" style={{ backgroundColor: "#18181B" }}>
        ...
        <div className="absolute inset-0" style={{ background: "linear-gradient(105deg, rgba(24,24,27,0.98) 50%, rgba(24,24,27,0.7) 100%)" }} />
        <div className="container relative z-10">
          ...
          <h1 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "clamp(2.5rem, 6vw, 4.5rem)", color: "#FFFFFF", lineHeight: 1.0, marginBottom: "1.25rem" }}>
            PRESSURE WASHING<br /><span style={{ color: "#F59E0B" }}>SUPPLY STORE</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4">
            <a href="tel:+19413774673" className="inline-flex items-center gap-2 px-7 py-4 rounded font-bold text-lg transition-all hover:scale-105 active:scale-95" style={{ backgroundColor: "#F59E0B", color: "#18181B", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase" }}>
      ...
      <section style={{ backgroundColor: "#18181B" }} className="py-20">
        <div className="container">
          <div className="mb-12">
            ...
            <p style={{ color: "#A1A1AA", lineHeight: 1.8, fontFamily: "'DM Sans', sans-serif", maxWidth: "700px" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {CATEGORIES.map((cat) => (
              <div key={cat.title} className="p-6 rounded-lg" style={{ backgroundColor: "#27272A", borderLeft: "4px solid #F59E0B", border: "1px solid rgba(255,255,255,0.06)", borderLeftWidth: "4px", borderLeftColor: "#F59E0B" }}>
                ...
                <ul className="space-y-2">
                  {cat.items.map((item) => (
                    <li key={item} className="flex items-start gap-2">
                      <div style={{ width: "5px", height: "5px", borderRadius: "50%", backgroundColor: "#F59E0B", marginTop: "8px", flexShrink: 0 }} />
          ...
          <div className="mt-16 p-8 rounded-lg text-center" style={{ backgroundColor: "#27272A", border: "1px solid rgba(245,158,11,0.2)" }}>
            <h3 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "2rem", color: "#FFFFFF", marginBottom: "0.75rem" }}>
              DON'T SEE WHAT YOU NEED?
            </h3>
            <p style={{ color: "#A1A1AA", fontFamily: "'DM Sans', sans-serif", marginBottom: "1.5rem" }}>
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="tel:+19413774673" className="inline-flex items-center gap-2 px-7 py-3 rounded font-bold transition-all hover:scale-105" style={{ backgroundColor: "#F59E0B", color: "#18181B", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, letterSpacing: "0.05em", textTransform: "uppercase" }}>
