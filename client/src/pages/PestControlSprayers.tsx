        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "2rem" }}>
            <div style={{ backgroundColor: "#FFFFFF", border: "1px solid #E5E0D8", borderRadius: "0.625rem", padding: "2rem", borderTopWidth: "3px", borderTopStyle: "solid", borderTopColor: "#FFD100" }}>
              ...
              <p style={{ color: "#6B7280", fontSize: "0.875rem", lineHeight: 1.7, marginBottom: "1rem" }}>We service all makes and models of commercial pest control and lawn care spray equipment. From pump rebuilds to complete system overhauls.</p>
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                {["Pump rebuilds and replacements", "Hose and fitting replacement", "Tank cleaning and repair", "Nozzle and boom service", "Agitator service", "Pressure regulator calibration", "Electric and gas pump service", "Diaphragm pump rebuilds"].map(i => (
                  <li key={i} style={{ display: "flex", alignItems: "center", gap: "0.5rem", color: "#4B5563", fontSize: "0.85rem", marginBottom: "0.4rem" }}>
            ...
            <div style={{ backgroundColor: "#FFFFFF", border: "1px solid #E5E0D8", borderRadius: "0.625rem", padding: "2rem", borderTopWidth: "3px", borderTopStyle: "solid", borderTopColor: "#3B82F6" }}>
              ...
              <p style={{ color: "#6B7280", fontSize: "0.875rem", lineHeight: 1.7, marginBottom: "1rem" }}>Need a custom spray rig built to your exact specifications? MHSS designs and builds commercial spray systems for pest control operators, lawn care companies, and agricultural applications.</p>
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
          ...
          <div style={{ backgroundColor: "#FFFFFF", border: "1px solid #E5E0D8", borderRadius: "0.625rem", padding: "2rem", marginTop: "2rem", textAlign: "center" }}>
            ...
            <p style={{ color: "#6B7280", fontSize: "0.875rem", marginBottom: "1.25rem" }}>Whether you need a repair, a replacement part, or a completely custom-built spray system — call MHSS to discuss your requirements.</p>
