      ...
      <section className="relative py-24 overflow-hidden" style={{ backgroundColor: "#404040" }}>
        ...
        <div className="container relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 600, fontSize: "0.75rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "#E03030" }}>
          ...
          <a
            ...
            style={{ backgroundColor: "#E03030", color: "#FFFFFF", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, letterSpacing: "0.05em", textTransform: "uppercase" }}
          >
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-10">
              <div>
                <div style={{ width: "2.5rem", height: "3px", backgroundColor: "#E03030", marginBottom: "1rem" }} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={item} className="flex items-start gap-3 p-3 rounded" style={{ backgroundColor: "#4A4A4A" }}>
                      <Zap size={14} style={{ color: "#E03030", marginTop: "3px", flexShrink: 0 }} />
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {[
                    ...
                    <div key={city} className="flex items-center gap-2 p-2 rounded" style={{ backgroundColor: "#4A4A4A" }}>
                      <MapPin size={12} style={{ color: "#E03030", flexShrink: 0 }} />
                      <span style={{ color: "#C0C0C0", fontSize: "0.8rem", fontFamily: "'DM Sans', sans-serif" }}>{city}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={step.step} className="flex gap-5 p-5 rounded-lg" style={{ backgroundColor: "#4A4A4A", border: "1px solid rgba(255,255,255,0.06)" }}>
                      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: "2rem", color: "#E03030", lineHeight: 1, flexShrink: 0, width: "2.5rem" }}>
                        {step.step}
                      </div>
                      <div>
                        ...
                        <p style={{ color: "#909090", fontSize: "0.875rem", lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif" }}>{step.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-lg" style={{ backgroundColor: "rgba(220,38,38,0.1)", border: "1px solid rgba(220,38,38,0.4)" }}>
                ...
                <a href="tel:+19413774673" className="flex items-center justify-center gap-2 w-full py-4 rounded font-bold text-xl transition-all hover:scale-105 emergency-pulse" style={{ backgroundColor: "#E03030", color: "#FFFFFF", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, letterSpacing: "0.05em", textTransform: "uppercase" }}>
              ...
              {[
                ...
                <div key={f.title} className="p-5 rounded-lg flex gap-4" style={{ backgroundColor: "#4A4A4A", border: "1px solid rgba(255,255,255,0.06)" }}>
                  <div className="w-10 h-10 rounded flex items-center justify-center shrink-0" style={{ backgroundColor: "rgba(220,38,38,0.12)", color: "#E03030" }}>
                    {f.icon}
                  </div>
                  <div>
